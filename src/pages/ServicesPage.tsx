...
const services = [
  ...
  },
  {
    ...
    desc: 'Start every morning with a beautifully written, personalized daily horoscope tailored to your sun, moon, and rising signs.',
    price: '₹99/mo',
    bg: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=500&h=300&fit=crop&auto=format&q=80',
    tag: 'Subscription',
    color: '#1e40af',
  },
  {
...
const corporatePackages = [
  ...
  },
  {
    ...
    features: ['Unlimited sessions', 'Custom AI integration', 'On-site workshops', 'Executive astrology coaching', 'White-label portal', '24/7 priority support'],
    color: '#0d5f4f',
  },
]
